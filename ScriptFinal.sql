...
CREATE TABLE [Visitas] (
    ...
    [ColorGafeteId] int NULL,
    [NumeroGafete] int NULL,
    ...
    CONSTRAINT [FK_Visitas_ColorGafete_ColorGafeteId] FOREIGN KEY ([ColorGafeteId]) REFERENCES [ColorGafete] ([Id]) ON DELETE NO ACTION,
...
VALUES (1, N'0451498b-5cd7-4c74-8dd8-8da0e2c77bae', N'Administrador', N'ADMINISTRADOR'),
(2, N'6710bf84-947c-459d-b150-be55639beccb', N'Usuario', N'USUARIO');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AspNetRoles]'))
...
VALUES (1, NULL, N'dfchacon@uned.cr', N'DFCHACON@UNED.CR', N'DANICHAC', N'AQAAAAEAACcQAAAAEDxxBWhDuzamdnrLOqaFodPr4McSfdouwgB3Nwn4RBcyn66QRzc1jHCHsgK73SVMsQ==', N'Chacón', N'Daniel', N'Navarro', N'', N'danichac'),
(2, NULL, N'kattia.alvarez@marriotthotels.com', N'KATTIA.ALVAREZ@MARRIOTTHOTELS.COM', N'KALVAREZ', N'AQAAAAEAACcQAAAAEIy8NER92gUKnyfhc5N6iPFI3gQD6UCJ7TZQtOyU3CMcIVouDmzmYiVk1dIzTwdZmg==', N'Álvarez', N'Kattia', N'', N'', N'kalvarez');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Email', N'NormalizedEmail', N'NormalizedUserName', N'password', N'primer_apellido', N'primer_nombre', N'segundo_apellido', N'segundo_nombre', N'nombre_usuario') AND [object_id] = OBJECT_ID(N'[AspNetUsers]'))
